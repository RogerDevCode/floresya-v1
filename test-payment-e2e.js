...
async function runCompletePaymentTest(page) {
  try {
    ...
    const checkoutBtn = await page.$(
      'button:has-text("Proceder al pago"), button:has-text("Checkout"), button:has-text("Pagar")'
    )
    ...
    await page.fill(
      ...
      'Av. Principal, Urbanización Los Palos Grandes, Caracas'
    )
    ...
    const submitBtn = await page.$(
      'button:has-text("Confirmar Pedido"), button:has-text("Finalizar Compra")'
    )
