...
/**
 * Generador de Instrucciones de Ejecución para Migración Fase 1
 */
...
async function generateInstructions() {
  ...
  console.log('📋 INSTRUCCIONES DE EJECUCIÓN - MIGRACIÓN FASE 1')
  console.log('='.repeat(70))
  console.log()
  ...
  // Leer el archivo SQL para mostrar estadísticas
  ...
  console.log('OPCIÓN 1: Ejecución Manual via Supabase Dashboard (RECOMENDADO)')
  console.log('-'.repeat(70))
  console.log()
  ...
  console.log(`   ${sqlPath}`)
  console.log('6. Hacer clic en "RUN" (botón azul)')
  console.log('7. Verificar que no hay errores en la salida')
  console.log('8. Revisar el log de notificaciones (debería mostrar "MIGRACIÓN FASE 1 COMPLETADA")')
  console.log()
  ...
  console.log('-'.repeat(70))
  console.log()
  console.log('1. Instalar CLI si no está instalado:')
  ...
  console.log('OPCIÓN 3: Script Node.js (con variables de entorno)')
  console.log('-'.repeat(70))
  console.log()
  ...
  console.log('='.repeat(70))
  console.log()
  console.log('Después de ejecutar la migración, verificar con estas queries:')
  console.log()
  ...
  console.log('-- Verificar índices nuevos')
  ...
  console.log('  ✓ orders.customer_phone, delivery_city, delivery_state')
  console.log('  ✓ order_items.product_id')
  console.log('  ✓ occasions.description')
  console.log('  ✓ product_images.file_hash')
  console.log('  ✓ payment_methods.description')
  console.log('  ✓ settings.value')
  console.log('  ✓ busquedas_log.* (5 campos)')
  console.log()
  console.log('Constraints CHECK (12+):')
  console.log('  ✓ users.password_required, full_name_min')
  console.log('  ✓ products.stock_max')
  console.log('  ✓ orders.cancelled_date, currency_rate')
  console.log('  ✓ payments.confirmed_date, transaction_id')
  console.log('  ✓ occasions.slug_format')
  console.log('  ✓ product_images.max_per_product')
  console.log('  ✓ busquedas_log.validations (3)')
  console.log()
  console.log('Triggers (2):')
  console.log('  ✓ validate_order_total')
  console.log('  ✓ sync_payment_method_name')
  console.log()
  console.log('Índices (5+):')
  console.log('  ✓ idx_products_search_vector (full-text)')
  console.log('  ✓ idx_occasions_active_display_order')
  console.log('  ✓ idx_product_occasions_occasion_id')
  console.log('  ✓ idx_busquedas_ip_fecha')
  console.log('  ✓ idx_busquedas_resultados')
  console.log()
  console.log('ENUMs (3):')
  console.log('  ✓ setting_type')
  console.log('  ✓ query_timeout_estado')
  console.log('  ✓ query_timeout_tipo')
  console.log()
  ...
  console.log('2. DOWNTIME: Puede haber breve downtime durante la migración')
  console.log('3. ROLLBACK: Revise MIGRATION_PHASE1_GUIDE.md para instrucciones de rollback')
  console.log('4. IDEMPOTENTE: El script puede ejecutarse múltiples veces sin problemas')
  console.log(
    '5. LIMPIEZA: El script limpia automáticamente datos NULL antes de aplicar constraints'
  )
  console.log()
  ...
  console.log('='.repeat(70))
  console.log()
  console.log('  📄 migrations/20251104_database_phase1_constraints.sql  (Script principal)')
  console.log('  📄 MIGRATION_PHASE1_GUIDE.md  (Guía completa)')
  console.log('  📄 DATABASE_AUDIT_REPORT.md  (Reporte de auditoría)')
  console.log('  📄 scripts/database/phase1-migration.js  (Script automatizado)')
  console.log('  📄 scripts/database/verify-phase1-ready.js  (Verificador)')
  console.log()
  ...
  console.log('='.repeat(70))
  console.log()
  console.log('Siguiente paso: Ejecutar la migración usando Opción 1 (Dashboard)')
  console.log()
}
