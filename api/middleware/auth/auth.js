/**
 * Authentication Middleware - ENTERPRISE SECURITY
 * - Development: Auto-inject mock user (NODE_ENV=development ONLY)
 * - Production: Real Supabase JWT verification (NO BYPASSES)
 * ENTERPRISE FAIL-FAST: Uses custom error classes
 * SECURITY COMPLIANCE: No production bypasses, proper error handling
 *
...
const IS_DEV = config.IS_DEVELOPMENT
...
export async function authenticate(req, res, next) {
  try {
    ...
    if (IS_DEV) {
      console.log('🔍 AUTH MIDDLEWARE - Development mode, injecting mock user')
