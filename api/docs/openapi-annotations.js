 ...
 *     description: Returns current system performance metrics including requests, errors, and response times
 *     responses:
 *       200:
 ...
 *                       type: object
 *                       properties:
 *                         requestCount: { type: integer, example: 1250 }
 *                         errorCount: { type: integer, example: 15 }
 *                         averageResponseTime: { type: number, example: 125.5 }
 *                         databaseResponseTime: { type: number, example: 45.2 }
 ...
 *   get:
 *     tags: [Health]
 *     summary: Get detailed metrics report
 *     description: Returns comprehensive metrics analysis and performance report
 *     responses:
 *       200:
 *         description: Metrics report generated successfully
 *         content:
 *           application/json:
 *             schema:
 *               allOf:
 ...
 *     description: Tests database connectivity and returns performance metrics
 *     responses:
 *       200:
 ...
 *                         connectionHealthy: { type: boolean, example: true }
 *       503:
 ...
 *     description: Returns current profiling session status (admin only in production)
 *     responses:
 *       200:
 *         description: Profiling status retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               allOf:
...
/**
 * @swagger
 * /health/profiling/start:
 *   post:
 *     tags: [Health]
 *     summary: Start profiling session
 *     description: Starts a new profiling session for performance analysis (admin recommended)
 *     requestBody:
 *       content:
 *         application/json:
 *           schema:
 *             type: object
 *             properties:
 *               duration: { type: integer, example: 60000, description: "Duration in ms" }
 *               sampleInterval: { type: integer, example: 10, description: "Sample interval in ms" }
 *     responses:
 *       200:
 *         description: Profiling started successfully
 *         content:
 *           application/json:
 *             schema:
 *               allOf:
...
/**
 * @swagger
 * /health/profiling/stop:
 *   post:
 *     tags: [Health]
 *     summary: Stop profiling session
 *     description: Stops the current profiling session and returns results
 *     responses:
 *       200:
 *         description: Profiling stopped successfully
 *         content:
 *           application/json:
 *             schema:
 *               allOf:
 ...
 *                         success: { type: boolean }
 *                         duration: { type: number }
 *                         resultsPath: { type: string, nullable: true }
 *       400:
 *         description: Failed to stop profiling
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
 ...
 *     description: Returns status of auto-recovery system and recent recovery attempts
 *     responses:
 *       200:
 ...
 *                         lastRecoveryAttempt: { type: string, format: date-time, nullable: true }
 *                         successfulRecoveries: { type: integer }
 *                         failedRecoveries: { type: integer }
 *       500:
 *         $ref: '#/components/responses/InternalServerError'
 */
 ...
 *     description: Returns detailed system diagnostics including process, environment, and monitoring information
 *     responses:
 *       200:
 ...
 *                           type: object
 *                           properties:
 *                             overheadAcceptable: { type: boolean }
 ...
 *     description: Admin only - Returns all expense categories with optional inactive filter
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Admin only - Creates a new expense category
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: true
 ...
 *     description: Admin only - Returns expenses with optional filters
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - name: startDate
 ...
 *     description: Admin only - Create expense with optional receipt upload
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       content:
...
/**
 * @swagger
 * /api/accounting/expenses/by-category:
 *   get:
 *     tags: [Accounting]
 *     summary: Get expenses grouped by category
 *     description: Admin only - Requires start and end date
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - name: startDate
 ...
 *     responses:
 *       200:
 *         description: Expenses by category retrieved
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/SuccessResponse'
 ...
 *     description: Admin only - Update with optional new receipt
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - $ref: '#/components/parameters/IdParam'
 ...
 *     description: Admin only - Last 7 days summary
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
...
/**
 * @swagger
 * /api/accounting/reports/current-week:
 *   get:
 *     tags: [Accounting]
 *     summary: Get current week report
 *     description: Admin only - Helper endpoint
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: Current week report retrieved
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/SuccessResponse'
...
/**
 * @swagger
 * /api/accounting/reports/monthly:
 *   get:
 *     tags: [Accounting]
...
/**
 * @swagger
 * /api/accounting/reports/current-month:
 *   get:
 *     tags: [Accounting]
 ...
 *     responses:
 *       200:
 *         description: Current month report retrieved
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/SuccessResponse'
 ...
 *     tags: [Admin Settings]
 *     summary: Save BCV USD rate
 *     description: Admin only - Update BCV exchange rate
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: true
 ...
 *     tags: [Admin Settings]
 *     summary: Get business rules status
 *     description: Admin only - Returns business rules engine status and configuration
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: Business rules status retrieved
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/SuccessResponse'
