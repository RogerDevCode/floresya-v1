...
class ExpenseCategoryService {
  ...
  async getAllCategories({ includeInactive = false } = {}) {
    try {
      ...
      logger.error('ExpenseCategoryService.getAllCategories error:', error)
      throw error
    }
  }
  ...
  async getCategoryById(id) {
    try {
      ...
      logger.error(`ExpenseCategoryService.getCategoryById(${id}) error:`, error)
      throw error
    }
  }
  ...
  async createCategory(categoryData, userId) {
    try {
      ...
      logger.error('ExpenseCategoryService.createCategory error:', error)
      throw error
    }
  }
  ...
  async updateCategory(id, updates) {
    try {
      ...
      logger.error(`ExpenseCategoryService.updateCategory(${id}) error:`, error)
      throw error
    }
  }
  ...
  async deleteCategory(id) {
    try {
      ...
      logger.error(`ExpenseCategoryService.deleteCategory(${id}) error:`, error)
      throw error
    }
  }
}
