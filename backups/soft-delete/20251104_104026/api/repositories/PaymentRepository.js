...
export class PaymentRepository extends BaseRepository {
  ...
  async findAllWithFilters(filters = {}, options = {}) {
    ...
    // No is_active column in payments table - use status filtering instead
  ...
  async findById(id, includeInactive = false) {
    ...
    // No is_active column - use status filtering instead
    if (!includeInactive) {
  ...
  async getStats(filters = {}) {
    ...
    const stats = {
      ...
      // No is_active column - use status for filtering
      byStatus: {
