...
export const getAllSettings = asyncHandler(async (req, res) => {
  ...
  const settings = await settingsService.getAllSettings(publicOnly, includeDeactivated)
...
export const getSettingsMap = asyncHandler(async (req, res) => {
  const publicOnly = req.query.public === 'true'
  const includeDeactivated = req.user?.role === 'admin'
  const map = await settingsService.getSettingsMap(publicOnly, includeDeactivated)
