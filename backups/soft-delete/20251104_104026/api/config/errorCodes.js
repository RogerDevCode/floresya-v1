...
/**
 * Check if error code is a "not found" type
 * @param {number} code - Error code to check
 * @returns {boolean} True if code is in not found range (3001-3999)
 */
export const isNotFoundCode = code => code >= 3001 && code <= 3999

// Alias for backward compatibility (deprecated - will be removed)
export const isNotFoundError = isNotFoundCode
