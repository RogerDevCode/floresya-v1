...
runTest('Storage pipeline functions correctly', async () => {
  try {
    const { uploadToStorage, uploadImageSizes } = await import(
      '../api/services/supabaseStorageService.js'
    )
...
runTest('Upload middleware is properly configured', async () => {
  try {
    ...
    const requiredExports = ['uploadSingle', 'uploadMultiple', 'handleMulterError']
