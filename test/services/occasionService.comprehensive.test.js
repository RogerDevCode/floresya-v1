  ...
  describe('updateOccasion', () => {
    ...
    it('should validate update data', () => {
      const validate = (data) => {
        ...
        if (data.active && typeof data.active !== 'boolean') {return false;}
        return true;
      };
  ...
  describe('Occasion Categories', () => {
    it('should categorize occasions', () => {
      const categorize = (occasion) => {
        ...
        if (personal.includes(occasion.slug)) {return 'personal';}
        if (social.includes(occasion.slug)) {return 'social';}
        if (seasonal.includes(occasion.slug)) {return 'seasonal';}
        return 'other';
      };
