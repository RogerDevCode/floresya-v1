...
} from '../dev-tools/generate-openapi-spec.js'
...
async function validateContractForCI() {
  ...
  try {
    ...
    try {
      const annotationsPath = path.resolve(__dirname, '../../api/docs/openapi-annotations.js')
...
async function generateCIReport(results) {
  try {
    const reportPath = path.resolve(__dirname, '../../api/docs/ci-contract-report.json')
    ...
    const simpleReportPath = path.resolve(__dirname, '../../api/docs/ci-report-simple.json')
